...
@Repository
public interface BulkUploadFileRepo extends JpaRepository<BulkUploadFileEntity, String> {
	...
	@Query("SELECT bue FROM BulkUploadFileEntity bue WHERE bue.id = :id AND bue.imCode = :imCode ORDER BY bue.updated DESC")
